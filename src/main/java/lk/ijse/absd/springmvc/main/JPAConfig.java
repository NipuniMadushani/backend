...
@EnableJpaRepositories(basePackageClasses = {CategoryRepository.class, ProductRepository.class, UserRepository.class, CartRepository.class, CartLineRepository.class,OrderDetailRepositpry.class})
